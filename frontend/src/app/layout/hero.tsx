    ...
    <div>
      ...
      >
        ...
        <div className="bg-opacity-0 flex flex-col w-full justify-start pt-40 items-start">
          <div className="items-start p-[59px] md:py-[50.5px] bg-opacity-100 dark:bg-opacity-80 rounded-0 bg-custom-grid bg-grid-size mx-[79px] justify-center">
            <div className="flex flex-wrap justify-start">
              ...
              <h1 className="text-gray-900 text-2xl md:text-3xl lg:text-5xl font-bold mb-3 text-center font-serif">
